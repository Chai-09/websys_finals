...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="assets/Favicons/register.png">
    ...
    <body>
        ...
        <div class="links" style="position: relative; float: left; margin-top: 730px; margin-left: 25px;">
            <div class="socialCard" style="position: absolute;">
                ...
                <a href="https://x.com/" class="socialContainer containerTwo">
