...
<html lang="en">
    ...
    <body>
        ...
        <div class="loader" id="modalBtn"></div>

        <div id="myModal" class="modal">
            <div class="modal-content">
                <span class="close"> &times; </span>
                <p> Pick an appropriate time and date for your appointment! 
                    If you have any concern or are unable to continue with your reservation, 
                    please contact us at <b>rtgCustomerSupport@gmail.com</b>, thank you!  </p>
            </div>
        </div>
        ...
        <script>
            ...
            // Clicking Outside of Modal Range Closes It
